...
class DrawLineWidget(object):
    def __init__(self):
        ...
        self.original_image  = cv2.resize(self.original_image,[500,500], interpolation = cv2.INTER_CUBIC)
        ...
        # pts2 = np.float32([[0,0],[70,0],[0,60],[70,60]])


        # M = cv2.getPerspectiveTransform(pts1,pts2)

        # self.original_image = cv2.warpPerspective(self.original_image,M,(70,60))
        # self.original_image = cv2.resize(self.original_image,dim,interpolation = cv2.INTER_CUBIC)
        
        # M = np.float32([[1,70,0],[60,1,0]])
        # self.original_image = cv2.warpAffine(self.original_image,M,(500,500))
